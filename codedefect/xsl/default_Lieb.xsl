...
<div id="header">
			...
			<div class="adblock">
			<script type="text/javascript" src="../Style/google_15.js"></script>
        ...
        <xsl:for-each select="b/m">             
          ...
          <object type="application/x-shockwave-flash"
			data="http://www.codedefect.com/flash/{$swfsrc}" 
			width="794px" height="294px">
			<param name="movie" 
			value="http://www.codedefect.com/flash/{$swfsrc}" />
 ...
 <a href="http://gb2312.spaces.live.com/blog/cns!3CDBA96A871601F6!44483.entry" title="发送 Belem Flash 教程的反馈以及建议信息">发送 Belem Flash 教程的反馈以及建议信息</a>
		...
		<div class="adblock">
			<script type="text/javascript" src="../Style/google_90.js"></script>
			<script type="text/javascript" src="http://pagead2.googlesyndication.com/pagead/show_ads.js"></script> 
		</div>
